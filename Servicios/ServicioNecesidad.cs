...
using ayudarApp.Entidades.Metadata;
    ...
    public class ServicioNecesidad
    {
...

        {
            Necesidades necesidades = new Necesidades()
            {
                ...
                TipoDonacion = (necesidadmd.TipoDonacion.Equals(Entidades.Enum.TipoDonacion.Monetaria)) ? 1 : 2,
        ...
        public NecesidadesMetadata ConvertirNecesidadAMetadata(Necesidades n)
        {
            NecesidadesMetadata meta = new NecesidadesMetadata()
            {
                ...
                TipoDonacion = (Entidades.TipoDonacion)(n.TipoDonacion == 1 ? Entidades.TipoDonacion.Monetaria : Entidades.TipoDonacion.Insumos)
            };
            return meta;
        }
